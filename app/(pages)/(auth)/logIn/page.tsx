...
export default function LogInPage() {
  return (
    <div className="w-full min-h-[calc(100vh-72px)] bg-main flex items-center justify-center p-6 py-12" dir="rtl">
      <div className="w-full max-w-md bg-main2 border border-color3/20 rounded-3xl p-8 shadow-[0_0_20px_rgba(23,229,207,0.15)] relative overflow-hidden">
        {/* Glow effect */}
        <div className="absolute -top-20 -left-20 w-40 h-40 bg-color3/20 blur-[50px] rounded-full"></div>
        ...
        <form className="flex flex-col gap-5 relative z-10">
          ...
          <div className="flex justify-between items-center text-sm">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-700 bg-main text-color3 focus:ring-color3 focus:ring-offset-main accent-color3 cursor-pointer" />
              <span className="text-gray-400 group-hover:text-gray-300 transition-colors">تذكرني</span>
            </label>
            <Link href="#" className="text-color3 hover:text-white transition-colors">
              هل نسيت كلمة المرور؟
            </Link>
          </div>
        ...
        <p className="text-center text-gray-400 mt-8 relative z-10">
          لا تمتلك حساب؟{' '}
          <Link href="/signIn" className="text-color3 font-bold hover:text-white transition-colors">
            إنشاء حساب جديد
          </Link>
        </p>
      </div>
