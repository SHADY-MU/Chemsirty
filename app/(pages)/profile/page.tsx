      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-6">
          <div className="bg-main2 border border-secondary/30 rounded-3xl p-8 flex flex-col items-center text-center shadow-[0_0_20px_rgba(23,229,207,0.1)] relative overflow-hidden group">
            <div className="absolute top-0 w-full h-32 bg-gradient-to-b from-secondary/20 to-transparent transition-all group-hover:from-secondary/30"></div>

            <div className="w-32 h-32 bg-main border-4 border-main2 outline outline-secondary/50 rounded-full flex items-center justify-center relative z-10 mb-4 shadow-xl overflow-hidden transition-transform group-hover:scale-105">
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-main2 border border-gray-800 rounded-3xl p-6 shadow-lg flex gap-4 items-center transition-all hover:border-secondary/30 hover:shadow-[0_0_15px_rgba(23,229,207,0.1)] cursor-default">
          ...
          <div className="bg-main2 border border-gray-800 rounded-3xl flex flex-col mt-2 shadow-xl overflow-hidden group">
            <div className="p-6 border-b border-gray-800 bg-black/20 flex justify-between items-center transition-colors group-hover:bg-black/30">
              ...
              <button className="text-secondary text-sm hover:underline hover:text-white transition-colors">عرض الكل</button>
            </div>

            <div className="p-6 flex flex-col gap-4">
              {[1, 2].map((course) => (
                <div key={course} className="bg-main flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between p-4 rounded-2xl border border-gray-800 hover:border-secondary/50 transition-all shadow-md">
                  ...
                  <button className="w-full sm:w-auto px-6 py-2.5 bg-secondary/10 text-secondary border border-secondary rounded-xl hover:bg-secondary hover:text-main2 transition-all shadow-[0_0_10px_rgba(23,229,207,0.1)] hover:shadow-none text-sm font-bold active:scale-95">
                    متابعة التعلم
                  </button>
                </div>
              ))}
